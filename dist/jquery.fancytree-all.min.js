...
/*! Extension 'jquery.fancytree.edit.min.js' */!function(e){"function"==typeof define&&define.amd?define(["jquery","./jquery.fancytree"],e):"object"==typeof module&&module.exports?(require("./jquery.fancytree"),module.exports=e(require("jquery"))):e(jQuery)}(function(l){"use strict";var t=/Mac/.test(navigator.platform),c=l.ui.fancytree.escapeHtml,u=l.ui.fancytree.trim,o=l.ui.fancytree.unescapeHtml;return l.ui.fancytree._FancytreeNodeClass.prototype.editStart=function(){var t,i=this,e=this.tree,r=e.ext.edit,n=e.options.edit,a=i.tr||i.span,s=l(n.spanClass,a),a={node:i,tree:e,options:e.options,isNew:l(i[e.statusClassPropName]).hasClass("fancytree-edit-new"),originalProperty:i.getProperty(n.property),input:null,dirty:!1};if(!1===n.beforeEdit.call(i,{type:"beforeEdit"},a))return!1;l.ui.fancytree.assert(!r.currentNode,"recursive edit"),r.currentNode=this,r.eventData=a,e.widget._unbind(),r.lastDraggableAttrValue=i.span.draggable,r.lastDraggableAttrValue&&(i.span.draggable=!1),l(document).on("mousedown.fancytree-edit",function(e){l(e.target).hasClass("fancytree-edit-input")||i.editEnd(!0,e)}),t=l("<input />",{class:"fancytree-edit-input",type:"text",value:e.options.escapeTitles?a.originalProperty:o(a.originalProperty)}),r.eventData.input=t,null!=n.adjustWidthOfs&&t.width(s.width()+n.adjustWidthOfs),null!=n.inputCss&&t.css(n.inputCss),s.html(t),t.focus().change(function(e){t.addClass("fancytree-edit-dirty")}).on("keydown",function(e){switch(e.which){case l.ui.keyCode.ESCAPE:i.editEnd(!1,e);break;case l.ui.keyCode.ENTER:return i.editEnd(!0,e),!1}e.stopPropagation()}).blur(function(e){return i.editEnd(!0,e)}),n.edit.call(i,{type:"edit"},a)},l.ui.fancytree._FancytreeNodeClass.prototype.editEnd=function(e,t){var i=this,r=this.tree,n=r.ext.edit,a=n.eventData,s=r.options.edit,o=i.tr||i.span,d=l(s.spanClass,o).find("input.fancytree-edit-input");return s.trim&&d.val(u(d.val())),o=d.val(),a.dirty=o!==i.getProperty(s.property),a.originalEvent=t,!1===e?a.save=!1:a.isNew?a.save=""!==o:a.save=a.dirty&&""!==o,!1!==s.beforeClose.call(i,{type:"beforeClose"},a)&&((!a.save||!1!==s.save.call(i,{type:"save"},a))&&(d.removeClass("fancytree-edit-dirty").off(),l(document).off(".fancytree-edit"),a.save?(i.setProperty(s.property,r.options.escapeTitles?o:c(o)),i.setFocus()):a.isNew?(i.remove(),i=a.node=null,n.relatedNode.setFocus()):(i.renderTitle(),i.setFocus()),n.eventData=null,n.currentNode=null,n.relatedNode=null,r.widget._bind(),i&&n.lastDraggableAttrValue&&(i.span.draggable=!0),r.$container.get(0).focus({preventScroll:!0}),a.input=null,s.close.call(i,{type:"close"},a),!0))},l.ui.fancytree._FancytreeNodeClass.prototype.editCreateNode=function(e,t){var i,r=this.tree,n=this;e=e||"child",null==t?t={title:""}:"string"==typeof t?t={title:t}:l.ui.fancytree.assert(l.isPlainObject(t)),"child"!==e||this.isExpanded()||!1===this.hasChildren()?((i=this.addNode(t,e)).match=!0,l(i[r.statusClassPropName]).removeClass("fancytree-hide").addClass("fancytree-match"),i.makeVisible().done(function(){l(i[r.statusClassPropName]).addClass("fancytree-edit-new"),n.tree.ext.edit.relatedNode=n,i.editStart()})):this.setExpanded().done(function(){n.editCreateNode(e,t)})},l.ui.fancytree._FancytreeClass.prototype.isEditing=function(){return this.ext.edit?this.ext.edit.currentNode:null},l.ui.fancytree._FancytreeNodeClass.prototype.isEditing=function(){return!!this.tree.ext.edit&&this.tree.ext.edit.currentNode===this},l.ui.fancytree.registerExtension({name:"edit",version:"2.39.0",options:{adjustWidthOfs:4,allowEmpty:!1,inputCss:{minWidth:"3em"},property:["title"],spanClass:".fancytree-title",triggerStart:["f2","mac+enter","shift+click"],trim:!0,beforeClose:l.noop,beforeEdit:l.noop,close:l.noop,edit:l.noop,save:l.noop},currentNode:null,treeInit:function(e){var r=e.tree;this._superApply(arguments),this.$container.addClass("fancytree-ext-edit").on("fancytreebeforeupdateviewport",function(e,t){var i=r.isEditing();i&&(i.info("Cancel edit due to scroll event."),i.editEnd(!1,e))})},nodeClick:function(e){var t=l.ui.fancytree.eventToString(e.originalEvent),i=e.options.edit.triggerStart;return"shift+click"===t&&0<=l.inArray("shift+click",i)&&e.originalEvent.shiftKey||"click"===t&&0<=l.inArray("clickActive",i)&&e.node.isActive()&&!e.node.isEditing()&&l(e.originalEvent.target).hasClass(e.options.edit.spanClass)?(e.node.editStart(),!1):this._superApply(arguments)},nodeDblclick:function(e){return 0<=l.inArray("dblclick",e.options.edit.triggerStart)?(e.node.editStart(),!1):this._superApply(arguments)},nodeKeydown:function(e){switch(e.originalEvent.which){case 113:if(0<=l.inArray("f2",e.options.edit.triggerStart))return e.node.editStart(),!1;break;case l.ui.keyCode.ENTER:if(0<=l.inArray("mac+enter",e.options.edit.triggerStart)&&t)return e.node.editStart(),!1}return this._superApply(arguments)}}),l.ui.fancytree});
